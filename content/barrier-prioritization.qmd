...
connect = api.watershed_connectivity("ALL", 'BELA')[0]
total = round(api.watershed_connectivity("ALL", 'BELA')[1],2) #total km in watershed
access = round(api.watershed_connectivity("ALL", 'BELA')[2],2)
